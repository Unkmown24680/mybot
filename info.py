...
URL = "https://movies-mahesh24680.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movies-mahesh24680.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movies-mahesh24680.koyeb.app/".format(FQDN)
else:
    URL = "https://movies-mahesh24680.koyeb.app/".format(FQDN)
